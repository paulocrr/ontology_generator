...
conceptnet_relations = [
    ...
    'HasSubevent', 'InheritsFrom', 'InstanceOf', 'IsA','IsHypernymOf',
    'IsHyponymOf','LocatedNear', 'LocationOfAction', 'MadeOf', 'MotivatedByGoal',
...
split_into_words = {
    ...
    'IsA': "is a",
    'IsHypernymOf': "is hypernym of",
    'IsHyponymOf': 'is hyponym of',
...
class GenerationDataLoader(adata.DataLoader):
    ...
    def load_data(self, path):
        ...
        for split in self.data:
            ...
            if os.path.isfile(path+"/dev3.txt"):
                  string_tuples = open("{}/{}".format(
                    path, "dev3.txt"), "r").read().split("\n")
                  tuples += [x.split("\t") for x in string_tuples if x]
                  print("Se adiciono el file dev3.txt")
