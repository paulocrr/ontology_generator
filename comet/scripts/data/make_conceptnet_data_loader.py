...
import torch
import comet.src.data.conceptnet as cdata
...
relations = [
    ...
    'InstanceOf', 'IsA','IsHypernymOf','IsHyponymOf', 'LocatedNear', 'LocationOfAction', 'MadeOf',
...
data_loader.load_data("comet/data/conceptnet")

data_loader.make_tensors(text_encoder, special, test=False)

opt.data.maxr = data_loader.max_r

save_path = "comet/data/conceptnet/processed/generation"
